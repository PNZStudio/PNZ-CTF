...
class TrueWalletClass {
	...
	public $mobile_api_gateway = "https://tmn-mobile-gateway.truemoney.com/mobile-api-gateway/";
	public $secret_key = "EK0ZAUJepPn8npzozLxnL-his5YDgCN6bzLI21rshD";
	public $device_id = "6sz0Dc4nOBKDuClyNfcaPDS5ADIFEEJddAGW";
	...
	public function GetTransaction ($limit = 7, $start_date = null, $end_date = null) {
		if (is_null($this->access_token)) return false;
		if (is_null($start_date) && is_null($end_date)) $start_date = date("Y-m-d", strtotime("-10 days") - date("Z") + 25200);
		if (is_null($end_date)) $end_date = date("Y-m-d", strtotime("+2 day") - date("Z") + 25200);
